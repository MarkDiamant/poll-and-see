...
function getSponsorTheme(theme: string | null) {
  const themes: Record<string, { card: string; cta: string; label: string; accent: string }> = {
    ...
    light: {
      card: "border-gray-300/70 bg-gray-200/90",
      cta: "border-gray-800 bg-gray-900 text-white hover:bg-gray-800",
      label: "text-gray-600",
      accent: "from-gray-600/50 via-gray-400/30 to-transparent",
    },
    softblue: {
      card: "border-sky-300/70 bg-sky-100/90",
      cta: "border-sky-800 bg-sky-900 text-white hover:bg-sky-800",
      label: "text-sky-700",
      accent: "from-sky-600/50 via-sky-400/30 to-transparent",
    },
    softgreen: {
      card: "border-emerald-300/70 bg-emerald-100/90",
      cta: "border-emerald-800 bg-emerald-900 text-white hover:bg-emerald-800",
      label: "text-emerald-700",
      accent: "from-emerald-600/50 via-emerald-400/30 to-transparent",
    },
    sand: {
      card: "border-stone-300/70 bg-stone-200/90",
      cta: "border-stone-800 bg-stone-900 text-white hover:bg-stone-800",
      label: "text-stone-600",
      accent: "from-stone-600/50 via-stone-400/30 to-transparent",
    },
    silver: {
      card: "border-slate-300/70 bg-slate-200/90",
      cta: "border-slate-800 bg-slate-900 text-white hover:bg-slate-800",
      label: "text-slate-600",
      accent: "from-slate-600/50 via-slate-400/30 to-transparent",
    },
    lavender: {
      card: "border-purple-300/70 bg-purple-100/90",
      cta: "border-purple-800 bg-purple-900 text-white hover:bg-purple-800",
      label: "text-purple-700",
      accent: "from-purple-600/50 via-purple-400/30 to-transparent",
    },
    sky: {
      card: "border-blue-300/70 bg-blue-100/90",
      cta: "border-blue-800 bg-blue-900 text-white hover:bg-blue-800",
      label: "text-blue-700",
      accent: "from-blue-600/50 via-blue-400/30 to-transparent",
    },
  };
