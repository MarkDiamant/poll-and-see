...
function getSponsorTheme(theme: string | null) {
  const themes: Record<string, { card: string; cta: string; label: string; accent: string }> = {
    ...
    light: {
      card: "border-gray-600/60 bg-[#1b1d21]",
      cta: "border-gray-500/40 bg-[#2a2d33] text-gray-100 hover:bg-[#353942]",
      label: "text-gray-400",
      accent: "from-gray-300/40 via-gray-500/20 to-transparent",
    },
    softblue: {
      card: "border-sky-900/40 bg-[#16202b]",
      cta: "border-sky-700/40 bg-[#223244] text-sky-100 hover:bg-[#2b4259]",
      label: "text-sky-300/70",
      accent: "from-sky-300/40 via-sky-500/20 to-transparent",
    },
    softgreen: {
      card: "border-emerald-900/40 bg-[#13211d]",
      cta: "border-emerald-700/40 bg-[#1e342d] text-emerald-100 hover:bg-[#27453b]",
      label: "text-emerald-300/70",
      accent: "from-emerald-300/40 via-emerald-500/20 to-transparent",
    },
    sand: {
      card: "border-stone-700/50 bg-[#221f1b]",
      cta: "border-stone-600/40 bg-[#332d27] text-stone-100 hover:bg-[#433a32]",
      label: "text-stone-300/70",
      accent: "from-stone-300/40 via-stone-500/20 to-transparent",
    },
    silver: {
      card: "border-slate-700/50 bg-[#1a2027]",
      cta: "border-slate-600/40 bg-[#28313c] text-slate-100 hover:bg-[#34404d]",
      label: "text-slate-300/70",
      accent: "from-slate-300/40 via-slate-500/20 to-transparent",
    },
    lavender: {
      card: "border-purple-900/40 bg-[#1d1725]",
      cta: "border-purple-700/40 bg-[#2d2238] text-purple-100 hover:bg-[#3a2c49]",
      label: "text-purple-300/70",
      accent: "from-purple-300/40 via-purple-500/20 to-transparent",
    },
    sky: {
      card: "border-blue-900/40 bg-[#151c28]",
      cta: "border-blue-700/40 bg-[#223246] text-blue-100 hover:bg-[#2c415c]",
      label: "text-blue-300/70",
      accent: "from-blue-300/40 via-blue-500/20 to-transparent",
    },
  };
