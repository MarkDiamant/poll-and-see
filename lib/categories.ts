...
export const RELATED_CATEGORY_ORDER: Record<string, string[]> = {
  ...
  Food: ["Lifestyle", "Health", "Community", "Parenting", "Fun", "General", "Business", "Education", "Finance", "Politics", "Technology", "Sports"],
  Fun: ["General", "Lifestyle", "Community", "Food", "Parenting", "Education", "Health", "Finance", "Business", "Technology", "Politics", "Sports"],
  General: ["Community", "Lifestyle", "Fun", "Parenting", "Education", "Politics", "Finance", "Business", "Food", "Health", "Technology", "Sports"],
  Health: ["Lifestyle", "Food", "Parenting", "General", "Community", "Education", "Finance", "Fun", "Business", "Technology", "Politics", "Sports"],
  Lifestyle: ["Community", "General", "Food", "Health", "Parenting", "Fun", "Finance", "Education", "Business", "Technology", "Politics", "Sports"],
...
export const CATEGORY_COLOURS: Record<string, { text: string; bg: string; border: string; solid: string }> = {
  ...
  Education: { text: "#f5e7c4", bg: "rgba(68, 26, 3, 0.28)", border: "rgba(120, 53, 15, 0.85)", solid: "#441a03" },
  ...
  Technology: { text: "#f3f4f6", bg: "rgba(107, 114, 128, 0.18)", border: "rgba(209, 213, 219, 0.82)", solid: "#6b7280" },
...
export const EMAIL_CATEGORY_COLOURS: Record<string, { text: string; bg: string; border: string }> = {
  ...
  Education: { text: "#f5e7c4", bg: "#2a1406", border: "#441a03" },
  ...
  Technology: { text: "#f3f4f6", bg: "#374151", border: "#d1d5db" },
